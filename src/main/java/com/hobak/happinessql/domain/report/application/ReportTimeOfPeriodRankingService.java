...
public class ReportTimeOfPeriodRankingService {
    ...
    public List<TimeOfDayRankingResponseDto> getAllTimeOfDayRankings(User user) {
        List<Record> records = recordRepository.findAllByUser(user);
        return TimeOfDayHappinessAnalyzer.getTimeOfDayRankings(records);
    }

    public List<TimeOfDayRankingResponseDto> getYearlyTimeOfDayRankings(User user) {
    ...
    public List<TimeOfDayRankingResponseDto> getMonthlyTimeOfDayRankings(User user) {
